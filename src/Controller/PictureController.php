...
class PictureController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        // Tell Doctrine you want to (eventually) save the picture (no queries yet)
    ...
    //Editer le picture et le sauvegarde en base de données
    ...
    //Supprime le picture de la base de données
